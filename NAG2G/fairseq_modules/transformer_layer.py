...
from NAG2G.utils import utils as NAG2GUtils
from NAG2G.fairseq_modules import TransformerConfig
from NAG2G.fairseq_modules import LayerNorm, MultiheadAttention
from NAG2G.fairseq_modules.fairseq_dropout import FairseqDropout
from NAG2G.fairseq_modules.quant_noise import quant_noise
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def __init__(
        ...
        self.attn_ln = (
            ...
            if NAG2GUtils.safe_getattr(cfg, "scale_attn", False)
            else None
        )
        self.nh = self.self_attn.num_heads
        self.head_dim = self.self_attn.head_dim
        scale_heads = NAG2GUtils.safe_getattr(cfg, "scale_heads", False)
        self.c_attn = (
        ...
        self.ffn_layernorm = (
            ...
            if NAG2GUtils.safe_getattr(cfg, "scale_fc", False)
            else None
        )
        self.w_resid = (
            nn.Parameter(
            ...
            if NAG2GUtils.safe_getattr(cfg, "scale_resids", False)
            else None
        )
