...
import math
from NAG2G.modules import MaskLMHead
...
from NAG2G.fairseq_modules.transformer_base import TransformerModelBase
# from NAG2G.fairseq_modules.transformer_decoder import TransformerDecoderBase
from NAG2G.fairseq_modules.transformer_config import (
    # TransformerConfig,
    gen_parser_from_dataclass,
)
from NAG2G.fairseq_decoder.transformer_config import TransformerConfig
from NAG2G.fairseq_decoder.transformer_decoder import TransformerDecoderBase
...
class NAG2GFBaseModel(BaseUnicoreModel):
    ...
    def add_args(parser):
        ...
        if flag_decoder_fairseq:
            ...
            NAG2GFBaseModel.default_common_add_args(parser)
...
@register_model_architecture("NAG2GF", "NAG2GF_fairseq")
